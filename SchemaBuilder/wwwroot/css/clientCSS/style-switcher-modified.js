var prefix = styleSwitcher.data('cookies-prefix'),
...
function createLESS() {
    ...
    $('head').append($('<link rel="stylesheet/less">').attr('href', '../css/clientCSS/less/themes/custom.less'));
}
...
function createLESSJS() {
    ...
    script.src = '../css/clientCSS/less/less.min.js';
